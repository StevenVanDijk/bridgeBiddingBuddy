...
testcases: Tuple[str, List[str], int, int, int, int, int, str, str] = [
    ...
    ('ikwilindeapptesten', ['1Hs'], 12, 5, 2, 4, 2, 'X', ''),
    ('geensaopenenmet15p', ['pass', 'pass', 'pass'], 15, 5, 5, 1, 2, '1Ds', ''),
    ('tussenbod', ['pass', '1♦'], 8, 4, 5, 2, 2, '1Hs', ''),
    ('ruitenisookmooi', ['pass', 'pass'], 13, 2, 4, 4, 3, '1Cs', ''),
    ('autogenerated', ['1♦', 'pass'], 8, 2, 4, 5, 2, '???',''),
    ('2klisookeenantwoord', ['1♣', 'pass'], 8, 3, 3, 2, 5, '2Cs', ''),
    ('crash', ['1♠', 'pass'], 8, 2, 3, 4, 4, '???', ''),
    ('hoogstekleur', [], 15, 1, 2, 4, 6, '1Cs', '')
    ]
