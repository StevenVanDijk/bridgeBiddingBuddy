...
class Mediator():
    ...
    def showAdvice(self):
        ...
        (bid, explainTag) = bids(list(self.bidding.current), self.bidding.nrOfPoints,
    ...
    def closeBidding(self):
        ...
        fileContract = "AP" if contract == "AP" else contract + " " + leader
        self.__storage.put(key, name=name, bid=value, contract=fileContract )
