...
testcases: Tuple[str, List[str], int, int, int, int, int, str, str] = [
    ...
    ('antwoordop2kl', ['2♣', 'pass'], 5, 3, 6, 2, 2, '2Ds', '2Cs-2Ds'),
    ('antwoordop2kl2', ['2♣', 'pass'], 9, 3, 6, 2, 2, '2Hs', '2Cs-2x'),
    ('Spelerheeftfoutgemaakt', ['1SA', 'pass', '2♥', 'pass', '2♠', 'pass'], 2, 1, 6, 3, 3, 'pass', 'normal_pass'),
    ('Jacobyvervolg', ['1SA', 'pass', '2♥', 'pass', '2♠', 'pass'], 2, 5, 2, 3, 3, 'pass', 'normal_pass'),
    ('Jacoby2SA', ['pass', 'pass', '2SA', 'pass'], 2, 5, 2, 3, 3, '3Hs', 'jacoby-2sa'),
    ('Stayman2SA', ['2SA', 'pass'], 5, 3, 4, 3, 3, '3Cs', 'stayman-2sa'),
    ('autogenerated', ['1♣', 'pass'], 12, 3, 2, 5, 3, '1Ds', 'answering_partnerClr'),
    ('autogenerated', ['1♥', 'pass', '3♥', '3♠', '4♥'], 5, 3, 4, 1, 5, '???', '???'),
    ('autogenerated', ['1♦', 'pass', '1♠', 'pass', '1SA'], 9, 2, 4, 3, 4, '???', '???'),
    ('autogenerated', ['1♥', 'pass', '3♥', 'pass', '4♥', 'pass'], 11, 2, 3, 4, 4, '???', '???'),
    ('autogenerated', ['1♦', 'pass', '2♣', 'pass', '2SA', 'pass'], 15, 3, 1, 4, 5, '???', '???')
    ]
