            ...
            for elem in addedbuttons:
                def invoke(elem):
                    if elem == '?':
                        ...
                        print("('autogenerated', %s, %d, %d, %d, %d, %d, '???')" % (str(bidding.current), bidding.nrOfPoints,
                                                                                    bidding.nrOfCards[spades], bidding.nrOfCards[hearts], bidding.nrOfCards[diamonds], bidding.nrOfCards[clubs]))
                        advice = bids(bidding.current, bidding.nrOfPoints,
                                      bidding.nrOfCards[spades], bidding.nrOfCards[hearts], bidding.nrOfCards[diamonds], bidding.nrOfCards[clubs])
